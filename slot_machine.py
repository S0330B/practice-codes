import random
print("Welcome")
user_input=input("Press Y to enter and Q to exit: ").lower()
if user_input == 'y':
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enough to bet that amount, your current balace is Rs {balance} ")
        else:
            break
    print(f"You are betting Rs {bet} on {lines} lines. Total bet is eual to Rs {total_bet} ")
...
def main():
    ...
    while True:
        ...
        answer= input("Press enter to play and press Q to Quit ").lower()
        if answer == 'q':
                break
